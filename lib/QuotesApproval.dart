...
class QuotesApproval extends StatefulWidget {
  ...
  final String title = "Quotes Approval";
}
...
class QuotesData extends State<QuotesApproval> {
  ...
  fetch(pageno, valueData, searchQuotesController) async {
    print("fetching");
    var url = Uri.parse('${widget.baseurl}' + Constants.DEANA_QUOTESAPPROVALFILTER);
    ;
...
//        }
  ...
  List<DropdownMenuItem<String>> _dropDownItem() {
    List<String> ddl = ["Pending", "Approved", "Auto-Approved", "Rejected"];
    return ddl
